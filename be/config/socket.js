...
// Lưu trữ socket IDs của người dùng theo user ID (sử dụng mảng)
...
io.on("connection", (socket) => {
    ...
    // Lắng nghe sự kiện tin nhắn riêng tư từ client
...
export { io, app, server, userSocketMap }; // Export userSocketMap